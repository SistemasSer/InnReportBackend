...
#             if periodo == 2020:
#                 base_url = "https://www.datos.gov.co/resource/78xz-k3hv.json?$limit=100000"
#                 campo_cuenta = 'codcuenta'
#             elif periodo == 2021:
#                 base_url = "https://www.datos.gov.co/resource/irgu-au8v.json?$limit=100000"
#                 campo_cuenta = 'codrenglon'
#             else:
#                 base_url = "https://www.datos.gov.co/resource/tic6-rbue.json?$limit=100000"
#                 campo_cuenta = 'codrenglon'
...
class BalCoopApiViewIndicador(APIView):
    ...
    def load_saldos_from_db(self, razon_social, saldos, periodo, mes, puc_codes):
        ...
        for result in query_results.iterator():
            saldos[razon_social][result["puc_codigo"]] = result["total_saldo"]
